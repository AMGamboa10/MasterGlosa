...
public class Glosa510 {
    ...
    public Glosa510(int id, String Patente, String Pedimento, String SeccionAduanera, String ClaveContribucion, String FormaPago, double ImportePago, String TipoPedimento, java.sql.Date FechaPagoReal) {
        this.id = id;
