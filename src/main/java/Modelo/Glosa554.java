...
public class Glosa554 {
    ...
    public Glosa554(int id, String Patente, String Pedimento, String SeccionAduanera, String Fraccion, String SecuenciaFraccion, String ClaveCaso, String IdentificadorCaso, String ComplementoCaso, Date FechaPagoReal) {
        this.id = id;
